...
② prompt strip — sticky bottom, full width; device badge right-aligned ([[roadmap/items/R309-multi-device-working-context]])
...
① discussion list in Context pane — toggle included/excluded at runtime ([[roadmap/items/R306-discussions-context-control]]); `*` on active discussion
② status strip — live token estimate for next payload; opens [[roadmap/wireframes/payload-preview]] on click or `gp`
...
### payload preview open (dialog overlays — see [[roadmap/wireframes/payload-preview]])
